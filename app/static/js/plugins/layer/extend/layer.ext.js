...
;!function () {
    ...
    layer.prompt = function (a, c) {
        ...
        return layer.open($.extend({
            ...
            yes: function (b) {
                var e = d.val();
                "" === e ? d.focus() : e.length > (a.maxlength || 500) ? layer.tips("&#x6700;&#x591A;&#x8F93;&#x5165;" + (a.maxlength || 500) + "&#x4E2A;&#x5B57;&#x6570;", d, {tips: 1}) : c && c(e, b, d)
            }
        }, a))
        ...
        if (a = a || {}, a.photos) {
            ...
            if (f.imgIndex = j + 1, g) {
                ...
                var k = $(a.photos), l = k.find(a.img || "img");
                ...
                if (c || k.find(h.img || "img").each(function (b) {
                    ...
                    i.push({
                        ...
                        layer.photos($.extend(a, {photos: {start: b, data: i, tab: a.tab}, full: a.full}), !0)
                    })
                }), !c) return
            }
